    ...
    return(
        <div>
            ...
            <main className="p-10 bg-black">
                ...
                <PontoCronologico ano={1976} titulo="Viking 1 e 2 - EUA " texto="Ambos os módulos tinham prevista a pesquisa de micro-organismos marcianos. Os resultados destas pesquisas ainda estão em debate. Os módulos de pouso forneceram vistas panorâmicas coloridas detalhadas do terreno marciano. Também monitorizaram o tempo marciano."/>
                ...
                <PontoCronologico ano={1977} titulo="Voyager 1 e 2 - EUA " texto="Voo de Passagem por Júpiter/Saturno/Úrano/Netuno."/>
